 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://cal.soap.app.com/", wsdlLocation = "http://localhost:8081/WebServiceCalculator-0.0.1-SNAPSHOT/cal?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://cal.soap.app.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/WebServiceCalculator-0.0.1-SNAPSHOT/cal?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://cal.soap.app.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cal.soap.app.com/", "CalculatorPort"), Calculator.class, features);
    }
